import type { TestGroupDefinition } from "./main.ts";
import type { TestCase } from "./rule_tester.ts";

export const TEST_GROUPS: TestGroupDefinition[] = [
  // ESLint
  {
    name: "eslint",
    ...
    ruleTesters: [{ type: "local", path: "lib/rule-tester/rule-tester.js" }],
    parsers: [{ type: "module", path: "@typescript-eslint/parser", lang: "ts" }],
  },
  ...
  // React
  {
    ...
    transformTestFilename: (filename: string) => {
      switch (filename) {
        case "ESLintRuleExhaustiveDeps-test.js":
          return "rules-of-hooks/exhaustive-deps";
        case "ESLintRulesOfHooks-test.js":
          return "rules-of-hooks/rules-of-hooks";
    ...
    prepare(require, mock) {
      ...
      mock(require.resolve("../src/shared/ReactCompiler.ts"), { allRules });
    },
    ...
    ruleTesters: [
      { type: "module", path: "eslint-v7" },
      { type: "module", path: "eslint-v8" },
      { type: "module", path: "eslint-v9" },
    ],

    parsers: [
      { type: "module", path: "babel-eslint", lang: "jsx" },
      { type: "module", path: "@babel/eslint-parser", lang: "jsx" },
      { type: "module", path: "hermes-eslint", lang: "jsx" },
      { type: "module", path: "@typescript-eslint/parser-v2", lang: "tsx" },
      { type: "module", path: "@typescript-eslint/parser-v3", lang: "tsx" },
      { type: "module", path: "@typescript-eslint/parser-v4", lang: "tsx" },
      { type: "module", path: "@typescript-eslint/parser-v5", lang: "tsx" },
    ],
  },
];
